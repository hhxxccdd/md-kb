...
// 1. Ai润色
aiRouter.post('/polish',(req,res) => handleAIStream(req,res,"polish"))

// 2. AI翻译
aiRouter.post("/translate", (req, res) => handleAIStream(req, res, "translate"));

// 3. 生成目录
aiRouter.post("/generate-toc", (req, res) => handleAIStream(req, res, "generateToc"));

// 4. 代码优化
aiRouter.post("/optimize-code", (req, res) => handleAIStream(req, res, "optimizeCode"));

// 5. 文档问答
aiRouter.post("/answer-doc", (req, res) => handleAIStream(req, res, "answerDoc"));
